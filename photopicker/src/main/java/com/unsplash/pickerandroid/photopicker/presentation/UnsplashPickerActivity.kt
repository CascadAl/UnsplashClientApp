...
class UnsplashPickerActivity : AppCompatActivity(), OnPhotoSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // click listeners
        unsplash_picker_back_image_view.setOnClickListener {
            onBackPressed() }
        unsplash_picker_cancel_image_view.setOnClickListener {
            onBackPressed() }
        unsplash_picker_clear_image_view.setOnClickListener {
            onBackPressed() }
        ...
        unsplash_picker_done_image_view.setOnClickListener {
            sendPhotosAsResult() }
